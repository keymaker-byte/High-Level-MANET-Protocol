...
namespace NetLayer
{
    ...
    public static class OpSystemType
    {
        ...
        /// Windows Mobile
        /// </summary>
        public const Int32 WINMOBILE5POCKETPC = 1;

        /// <summary>
        /// Windows Mobile
        /// </summary>
        public const Int32 WINMOBILE6SMARTPHONE = 2;

        /// <summary>
        /// Samsung Omnia 2
        /// </summary>
        public const Int32 SAMSUNGOMNIAII = 3;

        /// <summary>
        /// Windows Mobile iPaq
        /// </summary>
        public const Int32 WINMOBILE5IPAQ = 4;
    }
