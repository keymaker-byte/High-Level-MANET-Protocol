...
namespace SystemInterop
{
    ...
    public class WlanClient
    {
        ...
        public class WlanInterface
        {
            ...
            /// <summary>
            /// Represents a method that will handle <see cref="WlanAdhocNetworkNotification"/> events.
            /// </summary>
            /// <param name="notifyData">The notification data.</param>
            /// <param name="reasonCode">The reason code.</param>
            public delegate void WlanAdhocNetworkNotificationEventHandler(Wlan.WlanNotificationData notifyData, Wlan.WlanAdhocNetworkState adhocNetworkState);
            ...
            /// <summary>
            /// Occurs when a WLAN operation change the connection state of an ad hoc network..
            /// </summary>
            public event WlanAdhocNetworkNotificationEventHandler WlanAdhocNetworkNotification;
            ...
            private struct WlanAdhocNetworkNotificationData
            {
                public Wlan.WlanNotificationData notifyData;
                public Wlan.WlanAdhocNetworkState adhocNetworkState;
            }
            #endregion
            ...
            public Wlan.WlanConnectionAttributes CurrentConnection
            {
                get
                {
                    ...
                    IntPtr valuePtr;
                    Wlan.WlanOpcodeValueType opcodeValueType;
                    int r = Wlan.WlanQueryInterface(client.clientHandle, info.interfaceGuid, Wlan.WlanIntfOpcode.CurrentConnection, IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType);
                    Wlan.ThrowIfError(r);
                    try
                    {
